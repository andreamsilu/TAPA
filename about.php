...
<style>
    ...
    .member_img {
        width: 100%; /* Ensure the image container takes the full width of the card */
        height: 200px; /* Fixed height for the image */
        overflow: hidden; /* Hide overflow for the image */
        display: flex;
        justify-content: center;
        align-items: center;
        margin-bottom: 15px; /* Space between the image and the next content */
    }
    ...
    .social {
        margin-top: auto; /* Ensure social icons are at the bottom */
    }

    .member-info h4 {
        margin-top: 10px; /* Space between name and position */
        font-size: 1.2rem;
    }

    .member-info span {
        color: #777; /* Color for the position */
    }
