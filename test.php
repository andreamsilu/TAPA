...
<head>
  ...
  <title>Psychological Association</title>
  <!-- Bootstrap CSS -->
  ...
  <style>
    ...
    .overlay {
      ...
      background-color: rgba(265, 255, 255, 0.6);
        ...
        <div class="col-lg-6 d-flex align-items-center">
          <div class="overlay card">
            <div class="card-body">
              ...
              <p class="card-text">The Tanzanian Psychological Association (TAPA) is committed to advancing psychology, fostering professional growth, advocating for mental health awareness, and much more.</p>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
          <div class="service-box">
            <img src="assets/img/carousel-images/advocacy.jpg" alt="" class="service-image">
