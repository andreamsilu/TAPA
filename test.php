...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    <!-- <a class="navbar-brand" href="#">TAPA</a> -->
    <a class="navbar-brand p-lg-3" href="index.php"><img src="assets/img/tapa.png" width="100px"></a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav class="col-12 col-lg-2 bg-light sidebar d-lg-flex d-none flex-column">
