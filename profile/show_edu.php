              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-danger delete-btn" href="delete-edu.php?id=<?php echo $row['id']; ?>"><i class="bi bi-trash"></i> Delete</button>
                        </td>
                  ...
                  <?php
                    ...
                    echo "<tr><td colspan='4'>No education details found.</td></tr>";
                  }
                  // Close connection
                  $conn->close();
                  ?>
