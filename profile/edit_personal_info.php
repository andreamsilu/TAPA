            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="row mx-2">
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            <label for="licensure_yes" class="col-form-label"><i class="bi bi-exclamation-triangle"></i> If Yes, please explain below</label>
                            <textarea class="form-control" name="licensure_yes" rows="3" value="<?php echo $row['yes_licensure']; ?>"></textarea>
                        </div>
                    </div>
                    ...
                    <div class=" col-md-6 form-group mt-5 mt-md-5 align-contnt-center">
