          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              <div class="icon">
                ...
                <img src="assets/img/service-img/progress.png" alt="" width="130px">
              </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              <div class="icon">
                ...
                <img src="assets/img/service-img/advocay4.png" alt="" width="130px">
              </div>
              <h4><a href="">Advocacy</a></h4>
              <p>The association advocate for the field of psychology and the interests of psychologists. TAPA may engage in advocacy efforts to promote mental health awareness, access to mental health services, and policies that support psychological research and practice.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              <div class="icon">
                ...
                <img src="assets/img/service-img/integrity.png" alt="" width="130px">

              </div>
              <h4><a href="">Ethics and Standards</a></h4>
              <p>The association typically establish and uphold ethical standards and guidelines for psychologists. It provide resources and support for members to ensure that they adhere to these ethical principles.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              <div class="icon">
                <!-- <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                  <path stroke="none" stroke-width="0" fill="#0F718A" d="M300,582.0697525312426C382.5290701553225,586.8405444964366,449.9789794690241,525.3245884688669,502.5850820975895,461.55621195738473C556.606425686781,396.0723002908107,615.8543463187945,314.28637112970534,586.6730223649479,234.56875336149918C558.9533121215079,158.8439757836574,454.9685369536778,164.00468322053177,381.49747125262974,130.76875717737553C312.15926192815925,99.40240125094834,248.97055460311594,18.661163978235184,179.8680185752513,50.54337015887873C110.5421016452524,82.52863877960104,119.82277516462835,180.83849132639028,109.12597500060166,256.43424936330496C100.08760227029461,320.3096726198365,92.17705696193138,384.0621239912766,124.79988738764834,439.7174275375508C164.83382741302287,508.01625554203684,220.96474134820875,577.5009287672846,300,582.0697525312426"></path>
                </svg>
                <i class="bx bx-file"></i> -->
                <img src="assets/img/service-img/teacher.png" alt="" width="130px">
              </div>
              <h4><a href="">Continuing Education</a></h4>
              <p>Association often offer opportunities for members to engage in continuing education and professional development activities to stay current with the latest developments in the field.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              <div class="icon">
                ...
                <img src="assets/img/service-img/research.png" alt="" width="130px">

              </div>
              <h4><a href="">Research and Education</a></h4>
              <p> Association often promote research in the field of psychology and support educational initiatives. This can include funding research projects, publishing journals, and facilitating knowledge-sharing among members.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              <div class="icon">
                ...
                <img src="assets/img/service-img/community.png" alt="" width="130px">
              </div>
              <h4><a href="">Community Outreach and Networking</a></h4>
              <p>The association has efforts to create a supportive network of professionals while also promoting mental health awareness and delivering services to the community.</p>
            </div>
          </div>
        </div>
